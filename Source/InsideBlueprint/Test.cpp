...
#include "InsideBlueprint/MyActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
INSIDEBLUEPRINT_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
INSIDEBLUEPRINT_API UClass* Z_Construct_UClass_AMyActor();
ENGINE_API UClass* Z_Construct_UClass_AActor();
UPackage* Z_Construct_UPackage__Script_InsideBlueprint();
...
UObject* (*const Z_Construct_UClass_AMyActor_Statics::DependentSingletons[])() = {
    ...
    (UObject* (*)())Z_Construct_UPackage__Script_InsideBlueprint,
};
#if WITH_METADATA
...
//IMPLEMENT_CLASS(AMyActor, 107446218);
#pragma region IMPLEMENT_CLASS
//#define IMPLEMENT_CLASS(TClass, TClassCrc) 
	static TClassCompiledInDefer<AMyActor> AutoInitializeAMyActor(TEXT("AMyActor"), sizeof(AMyActor), 107446218); 
...
template<> INSIDEBLUEPRINT_API UClass* StaticClass<AMyActor>()
{
    return AMyActor::StaticClass();
}
static FCompiledInDefer Z_CompiledInDefer_UClass_AMyActor(Z_Construct_UClass_AMyActor, &AMyActor::StaticClass, TEXT("/Script/InsideBlueprint"), TEXT("AMyActor"), false, nullptr, nullptr, nullptr);
